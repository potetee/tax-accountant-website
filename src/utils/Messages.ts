...
export const SERVICE2_DESCRIPTION = 'お客様が本当に望んでいらっしゃることは何か、そのことにこだわって業務を行います。\n' +
    '幅広いかつ専門的なニーズに対応するため提携のコンサルティング会社や各士業の専門家と連携して、総合的なサービスを提供致します。';
...
export const titleAndContent: {title:string,content:string }[] = [
    {
        ...
        content:'1982年、石川県小松市出身。明治大学商学部卒業。\n' +
            '大学卒業後、新聞社で広告の営業を経験。\n' +
            'その後、3つの税理士事務所で個人・法人の税務について幅広い業務を経験。\n\n' +
            '2019年1月 税理士資格取得\n' +
